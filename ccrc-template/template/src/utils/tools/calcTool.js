const calcTool = {
    ...
    floatCHEN: (num1 = 0, num2 = 1, fixed = 20) => {
        let m = 0,
            s1 = num1.toString(),
            s2 = num2.toString()
        try {
    ...
    floatCHU: (num1 = 0, num2 = 1, fixed = 20) => {
...
const getJiaJianVal = (num1, num2) => {
    const [r1, r2] = getDecimalLength(num1, num2)
    const m = Math.pow(10, Math.max(r1, r2))
    return [m, r1, r2]
}

const getDecimalLength = (num1, num2) => {
    let r1, r2
    try {
